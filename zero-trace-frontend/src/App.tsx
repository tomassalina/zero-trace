...
import { ZeroTraceGame } from './games/zero-trace/ZeroTraceGame';

const GAME_ID = 'zero-trace';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'Zero Trace';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_ZERO_TRACE_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
