import { Client as ZeroTraceClient, type Game } from './bindings';
...
/**
 * Service for interacting with the ZeroTrace game contract
 */
export class ZeroTraceService {
  ...
  private createSigningClient(
    ...
    return new ZeroTraceClient(options);
  }
  ...
  async prepareStartGame(
    ...
    const buildClient = new ZeroTraceClient({
      contractId: this.contractId,
      networkPassphrase: NETWORK_PASSPHRASE,
      rpcUrl: RPC_URL,
...
// Example: const zeroTraceService = new ZeroTraceService(contractId);
